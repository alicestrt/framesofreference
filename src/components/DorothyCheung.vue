...
<div>
    ...
    <b-row>
        <b-col md="6" offset-md="3">
          <b-img class="photo" center src="media/dorothy.svg"></b-img>
        </b-col>
    </b-row>

    <b-row>
        <b-col md="6" offset-md="3">
          <p class= "interview_name"> Dorothy Cheung </p>
        </b-col>
    </b-row>
...
<p class="interviewbody">I noticed the card and cash thing because the first months in The Netherlands was really difficult without cards (I guess you noticed that as well), even getting a beer at WORM (a local bar in Rotterdam) requires a working PIN card. And of course, with the protests now in Hong Kong, people try to avoid using the transport card (esp those that are not anonymous). One thing is the MTR (the transport operator in Hong Kong), is known to be working with the government. The other thing is they can easily track down a person with the data. Taking the bus or minibus, on the other hand, is a much safer option, as you can simply get away with coins and cash.
</p>
