...
This is more important than anything any architect or designer can build.
  ...
  <p class="interviewbody"> I think this idea of holding eachother accountable can be explored a bit. On one hand, we could have a panopticon effect, you know you are being watched, so you behave, but on the other hand, I think there needs to be thought on the ways you hold eachother accountable. There are all these surveillance snitch apps like <a href="https://citationsneeded.libsyn.com/episode-97-porch-pirate-panic-and-the-paranoid-racism-of-snitch-apps"> Nextdoor</a> where you can anonymusly report your neighbour. In a sense that is a form of accountability, but it takes away from the care and trust that I think is missing (and why we feel we need covid track and trace apps in the first place).
  </p>
